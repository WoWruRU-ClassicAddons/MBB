if( GetLocale() == "ruRU" ) then
	...
	MBB_OPTIONS_SLIDERLABEL = "Время задержки:";
	MBB_OPTIONS_EXPANSIONLABEL = "Раскрывать:";
	...
	MBB_OPTIONS_MAXBUTTONSLABEL = "Количество кнопок на строке:";
